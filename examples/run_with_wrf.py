"""
Example of how to run a SOLWEIG-GPU simulation using WRF data.
"""
...
base_path = 
'/path/to/your/input_rasters'

# Path to the directory containing your WRF output files
data_folder = 
'/path/to/your/wrfout_data'
...
if __name__ == '__main__':
    print("Running SOLWEIG-GPU with WRF data...")
