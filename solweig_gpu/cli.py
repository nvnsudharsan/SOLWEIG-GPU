...
def main():
    ...
    parser.add_argument('--own_metfile', help='Path to your own meteorological file')
    ...
    parser.add_argument('--data_folder', help='folder for meteorological data source, if it is ERA5 to WRF')
    parser.add_argument('--start', help='Start time of the input file(e.g., '2020-08-12 00')')
    parser.add_argument('--end', help='End time of the input file(e.g., '2020-08-14 23')')
